								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" width="18%" colspan="8">
										...
										<s:if test="pageBean.page != 1">
											<a href="${ pageContext.request.contextPath }/order_adminFindByState.action?page=1&state=<s:property value="#order.state"/>">首页</a> |
											<a href="${ pageContext.request.contextPath }/order_adminFindByState.action?page=<s:property value="pageBean.page-1"/>&state=<s:property value="#order.state"/>">上一页</a> |
										</s:if>
										<s:if test="pageBean.page != pageBean.totalPage">
											<a href="${ pageContext.request.contextPath }/order_adminFindByState.action?page=<s:property value="pageBean.page+1"/>&state=<s:property value="#order.state"/>">下一页</a> |
											<a href="${ pageContext.request.contextPath }/order_adminFindByState.action?page=<s:property value="pageBean.totalPage"/>&state=<s:property value="#order.state"/>">尾页</a>
										</s:if>
									</td>
